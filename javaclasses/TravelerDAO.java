...
import javaclasses.DB; // Χρειαζόμαστε την κλάση DB
...
public class TravelerDAO {
    ...
    public boolean deleteTraveler(int travelerId) {
        ...
        try (Connection connection = getConnection();
             PreparedStatement preparedStatement = connection.prepareStatement(DELETE_TRAVELER)) { // Εδώ έλειπε το {
    ...
    public Traveler getTravelerByUserId(int userId) {
        ...
        try (Connection connection = getConnection();
             PreparedStatement preparedStatement = connection.prepareStatement(SELECT_TRAVELER_BY_USER_ID)) {
